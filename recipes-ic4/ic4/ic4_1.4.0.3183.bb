...
SRC_URI = "file://ic4-archive_${PV}_aarch64_minsizerel.tar.gz;subdir=${BPN}-${PV};striplevel=1"


inherit bin_package

RDEPENDS:${PN} += "qtbase libjpeg-turbo tiff fmt pugixml libzip libpng spdlog"
